...
class ApolloServer extends apollo_server_core_1.ApolloServerBase {
    ...
    applyMiddleware({ app, path, cors, bodyParserConfig, disableHealthCheck, onHealthCheck, }) {
        ...
        app.use(middlewareFromPath(path, (_ctx, next) => __awaiter(this, void 0, void 0, function* () {
        ...
        if (cors === true) {
            app.use(middlewareFromPath(path, cors_1.default()));
        }
        else if (cors !== false) {
            app.use(middlewareFromPath(path, cors_1.default(cors)));
        }
        if (bodyParserConfig === true) {
            app.use(middlewareFromPath(path, koa_bodyparser_1.default()));
        }
        else if (bodyParserConfig !== false) {
            app.use(middlewareFromPath(path, koa_bodyparser_1.default(bodyParserConfig)));
        }
